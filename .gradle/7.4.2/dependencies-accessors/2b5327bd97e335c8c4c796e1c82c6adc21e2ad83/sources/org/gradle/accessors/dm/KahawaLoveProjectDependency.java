...
public class KahawaLoveProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":kahawaLovebenchmark"
     */
    public KahawaLovebenchmarkProjectDependency getKahawaLovebenchmark() { return new KahawaLovebenchmarkProjectDependency(getFactory(), create(":kahawaLovebenchmark")); }
    ...
    /**
     * Creates a project dependency on the project at path ":mkahawaemoBenchmark"
     */
    public MkahawaemoBenchmarkProjectDependency getMkahawaemoBenchmark() { return new MkahawaemoBenchmarkProjectDependency(getFactory(), create(":mkahawaemoBenchmark")); }
